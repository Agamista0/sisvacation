      ...
      <div className="trip-card">
        ...
        <div className='trip-card-images'>
          <div className='trip-card-images-left'>
            ...
            <img src={require(`../media/${offer.product_img}`)} alt="Main offer" />
          </div>
          <div className='trip-card-images-right'>
            ...
            <div className='trip-card-images-right-top'>
              <img src={require(`../media/${offer.product_img}`)} alt="Offer 2" />
              <img src={require(`../media/${offer.product_img}`)} alt="Offer 3" />
            </div>
            <div className='trip-card-images-right-bottom'>
              <img src={require(`../media/${offer.product_img}`)} alt="Offer 1 again" />
            </div>
          </div>
        </div>
      </div>
