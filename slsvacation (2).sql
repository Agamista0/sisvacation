...
INSERT INTO `offer` (`id`, `title`, `price`, `location`, `description`, `product_img`, `avg_rating`) VALUES
(1, 'LUXOR WITH VALLEY OF KINGS BY BUS', '34', 'Hurgada', 'GUIDED TRIP', 'offer2.webp', 0),
(2, 'LUXOR WITH VALLEY OF KINGS BY BUS', '34', 'Hurgada', 'DayTrip', 'offer1.webp', 0),
(3, 'LUXOR WITH VALLEY OF KINGS BY BUS', '234', 'Hurgada', 'Private Trip', 'offer3.webp', 5),
(4, 'LUXOR WITH VALLEY OF KINGS BY BUS', '23', 'Hurgada', 'Entry Ticket', 'offer4.webp', 0),
(5, 'LUXOR WITH VALLEY OF KINGS BY BUS', '21', 'Cairo ', 'Entry Ticket', 'offer5.webp', 0),
(6, 'LUXOR WITH VALLEY OF KINGS BY BUS', '21', 'Cairo ', 'Entry Ticket', 'offer6.webp', 0),
(7, 'LUXOR WITH VALLEY OF KINGS BY BUS', '865', 'Cairo ', 'Entry Ticket', 'offer7.webp', 4.07143),
(8, 'LUXOR WITH VALLEY OF KINGS BY BUS', '124', 'Cairo ', 'Entry Ticket', 'offer8.webp', 0);
...
INSERT INTO `trips` (`id`, `firstName`, `lastName`, `email`, `country`, `Phone`, `address`, `tripType`, `numberOfTravelers`, `averageAge`, `budget`, `destination`, `checkInDate`, `checkOutDate`, `additionalInfo`, `subscribeNewsletter`) VALUES
(13, 'سيف الدين', 'صلاح', 'jakeshanks7828@gmail.com', 'Egypt', '01096020602', 'address at 12412', 'FRIENDS TRIP', 12, 21, '3000', 'Luxor', '2024-07-20', '2024-07-20', 'what are the details for the trip ', 0);
