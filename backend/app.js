...
const API_BASE_URL = 'https://slsvacation.com';
...
app.use((req, res, next) => {
    const allowedOrigins = ['https://slsvacation.com', 'http://localhost:3000']; // Add more allowed origins if needed
...
export const getProductsCountCart = () => axios.get(`${API_BASE_URL}/getProductsCountCart`);
