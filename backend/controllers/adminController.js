...
const getCallRequests = (req, res) => {
  ...
  const query = `
    INSERT INTO offer
    (title, highlights, price, location, description, product_img, img2, img3, img4, includes, duration, included, meeting)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  `;
...
export { getCallRequests , addOffer, deleteCallRequest, adminLogin };
