...
const addReview = (req, res) => {
    const { offerId,  rating, reviewText, username } = req.body;
    const sessionId = req.cookies.token;

    const query = 'INSERT INTO reviews (offer_id, session_id, rating, review_text, username) VALUES (?, ?, ?, ?, ?)';
    db.query(query, [offerId, sessionId, rating, reviewText, username], (err, result) => {
      if (err) {
